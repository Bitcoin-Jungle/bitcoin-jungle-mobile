...
export const WelcomeFirstScreen: ScreenType = ({ navigation }: Props) => {
  ...
  return (
  <Swiper loop={false} activeDot={<View style={styles.activeDot} />} dot={<View style={styles.dot} />}>
    <Screen backgroundColor={colors.backgroundSecondary} statusBar={colors.text === palette.white ? "light-content" : "dark-content"}>
